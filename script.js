	...
	const prizes = [
		{
			...
			title: 'Bunny',
			detail: 'If you add up all the members of your team memberes and it reaches 42, you gain a defense'
		},
		{
			image: 'https://assets.codepen.io/2509128/prize2.png',
			title: 'Teddy Bear',
			detail: 'If the sum of all team members is 100 or more, you lose one life. (66 if you are less than 3 people)'
		},
		{
			image: 'https://assets.codepen.io/2509128/prize3.png',
			title: 'Polar Bear',
			detail: 'The team that multiplies all of its team members scores and produces the highest score gains a defense'
		},
		{
			image: 'https://assets.codepen.io/2509128/prize4.png',
			title: 'Polar Bear Bride',
			detail: 'If you have a same score with your teammate, you lose a life'
		},
		{
			image: 'https://assets.codepen.io/2509128/prize4.png',
			title: 'Polar Bear Bride',
...
const gsapCompleteCallback = (prizeDetail) => {
	// Create and append the reset button
	const resetButton = document.createElement('button');
	resetButton.innerText = 'Pick Again';
	resetButton.style.position = 'fixed';
	resetButton.style.bottom = '10rem'; // Adjust bottom position as needed
	resetButton.style.zIndex = 100;
	resetButton.style.left = '50%';
	resetButton.style.transform = 'translateX(-50%)';
	resetButton.addEventListener('click', () => location.reload()); // Reload the page when the button is clicked

	document.body.appendChild(resetButton);

	const prizeDetailElement = document.createElement('div');
	prizeDetailElement.innerText = prizeDetail;
	prizeDetailElement.style.position = 'fixed';
	prizeDetailElement.style.top = '50%';
	prizeDetailElement.style.right = '20%'; // Adjust right position as needed
	prizeDetailElement.style.transform = 'translateY(-50%)';
	prizeDetailElement.style.fontSize = '24px'; // Adjust font size as needed
	prizeDetailElement.style.fontWeight = 'bold'; // Adjust font weight as needed
	prizeDetailElement.style.color = 'white'; // Adjust text color as needed
	prizeDetailElement.style.zIndex = 100;
	prizeDetailElement.style.width = '200px'; // Set a fixed width
	prizeDetailElement.style.overflowWrap = 'break-word';
	document.body.appendChild(prizeDetailElement);


	// Remove the machine element
	$machine.remove();
};
...
const pop = () => {
	...
	gsap.to($machine, {
		...
		duration: 1,
		delay: 1,
		onComplete: gsapCompleteCallback(prize.detail),
	});
}
